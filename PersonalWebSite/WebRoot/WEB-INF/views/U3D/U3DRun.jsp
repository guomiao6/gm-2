						...
						<div class="row-fluid">
							...
							<div class="span4">
								<a class="btn btn-warning btn-block btn-large"  target="_blank"
									type="button" href="http://pan.baidu.com/s/1gf4mnVd">Android下载</a>
							</div>
						</div>
					</div>
					<div class="page-header">
						...
						<div class="carousel slide" id="carousel-145926">
							...
							<div class="carousel-inner">
								<div class="item">
									<img src="img/U3DGameThumbnails/run3.png" />
								</div>
								<div class="item active">
									<img src="img/U3DGameThumbnails/run1.png" />
								</div>
								<div class="item">
									<img src="img/U3DGameThumbnails/run2.png" />
								</div>
							</div>
