						...
						<div class="row-fluid">
							<div class="span4">
								<a class="btn btn-warning btn-block btn-large"  target="_blank"
									type="button" href="U3DGame/Dark/Dark.html">在线游戏</a>
							</div>
							<div class="span4">
								<a class="btn btn-warning btn-block btn-large"  target="_blank"
									type="button" href="http://pan.baidu.com/s/1jH9pAMq">Windows下载</a>
							</div>
							<div class="span4">
					...
					<div class="page-header">
						...
						<div class="carousel slide" id="carousel-145926">
							...
							<div class="carousel-inner">
								<div class="item">
									<img src="img/U3DGameThumbnails/dark3.png" />
								</div>
								<div class="item active">
									<img src="img/U3DGameThumbnails/dark1.png" />
								</div>
								<div class="item">
									<img src="img/U3DGameThumbnails/dark2.png" />
								</div>
							</div>
