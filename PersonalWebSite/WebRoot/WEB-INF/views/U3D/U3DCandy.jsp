			...
			<div class="row-fluid" style="vertical-align: middle;">
				<div class="span12">
					...
					<div class="alert" style="text-align: center;">
						...
						<h4>在线游戏可以通过右键->GoFullscreen来全屏游戏，或按F11全屏网页。</h4>
					</div>
						...
						<div class="row-fluid">
							<div class="span4">
								<a class="btn btn-warning btn-block btn-large" target="_blank"
									type="button" href="U3DGame/Candy/Web.html">在线游戏</a>
							</div>
							<div class="span4">
								<a class="btn btn-warning btn-block btn-large" target="_blank"
									type="button" href="http://pan.baidu.com/s/1dFmFxjN">Windows下载</a>
							</div>
							<div class="span4">
								<a class="btn btn-warning btn-block btn-large disabled"
									type="button">Android下载</a>
							</div>
						</div>
					</div>
					<div class="page-header">
						...
						<div class="carousel slide" id="carousel-145926">
							...
							<div class="carousel-inner">
								<div class="item">
									<img src="img/U3DGameThumbnails/candy3.png" />
								</div>
								<div class="item active">
									<img src="img/U3DGameThumbnails/candy1.png" />
								</div>
								<div class="item">
									<img src="img/U3DGameThumbnails/candy2.png" />
								</div>
							</div>
