			...
			<div class="row-fluid" style="vertical-align: middle;">
				<div class="span12">
					...
					<div class="alert" style="text-align: center;">
						...
						<h4><strong>本游戏的图像合成部分由刘从平同学完成。</strong></h4>
					</div>
						...
						<div class="row-fluid">
							<div class="span4">
								<a class="btn btn-warning btn-block btn-large"  target="_blank"
									type="button" href="U3DGame/CS/CS.html">在线游戏</a>
							</div>
							<div class="span4">
								<a class="btn btn-warning btn-block btn-large"  target="_blank"
									type="button" href="http://pan.baidu.com/s/1o8F3sQe">Windows下载</a>
							</div>
							<div class="span4">
								<button class="btn btn-warning btn-block btn-large disabled"
									type="button">Android下载</button>
							</div>
						</div>
					</div>
					<div class="page-header">
						...
						<div class="carousel slide" id="carousel-145926">
							...
							<div class="carousel-inner">
								<div class="item">
									<img src="img/U3DGameThumbnails/cs3.png" />
								</div>
								<div class="item active">
									<img src="img/U3DGameThumbnails/cs1.png" />
								</div>
								<div class="item">
									<img src="img/U3DGameThumbnails/cs2.png" />
								</div>
							</div>
